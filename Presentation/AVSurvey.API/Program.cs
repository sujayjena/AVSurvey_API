...
{
    options.SwaggerDoc("v1", new OpenApiInfo { Title = "AVSurvey API", Version = "v1" });
...
//Web Application related configurations
{
    ...
    app.UseSwaggerUI(s =>
    {
        s.SwaggerEndpoint("/swagger/v1/swagger.json", "AVSurvey API");
